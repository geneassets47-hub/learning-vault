...
{{
  ...
  "summary": "まず動画/記事の中心的な主張・結論を1文で示す。次に、なぜその結論に至るのかを発言者の論拠（データ・事例・因果関係）で説明する。登場人物が複数なら各自の主張と立場を対比して書く。議論に反論・条件付きがあればそれも含める。【何の話か】等の見出しは使わず本文のみ。これを読むだけで元の動画/記事を見直さなくても人に説明できるレベルにする。",
